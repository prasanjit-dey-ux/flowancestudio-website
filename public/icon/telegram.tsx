...
export default function TelegramIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <circle cx="10" cy="10" r="8.75" fill="url(#paint0_linear_88_1211)" />
      <path
      ...
      />
      <defs>
        <linearGradient id="paint0_linear_88_1211" x1="10" y1="1.25" x2="10" y2="18.75" gradientUnits="userSpaceOnUse">
